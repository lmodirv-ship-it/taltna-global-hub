...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Taltna Global — منصة المعرفة العالمية" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Taltna Global — منصة المعرفة العالمية" },
      { property: "og:description", content: "Taltna Global — منصة عالمية للمعرفة والإبداع" },
      { name: "twitter:description", content: "Taltna Global — منصة عالمية للمعرفة والإبداع" },
