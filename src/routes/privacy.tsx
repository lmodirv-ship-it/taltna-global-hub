  ...
  return (
    <PageShell title="سياسة الخصوصية" subtitle="آخر تحديث: 1 يونيو 2026" crumbs={[{ label: "الخصوصية" }]}>
      <article className="glass rounded-2xl p-8 max-w-3xl mx-auto space-y-5 leading-loose text-foreground/90">
        <p>تحرص منصة HN-global على حماية خصوصية مستخدميها. توضح هذه السياسة كيف نجمع بياناتك ونستخدمها ونحميها.</p>
        ...
        <p>يحق لك الوصول لبياناتك، تصحيحها، حذفها، أو نقلها. تواصل معنا عبر privacy@hn-global.com لأي طلب.</p>
